...
| Toolset | Core | Tools |
|---------|:----:|-------|
| `confluence_pages` | Yes | `confluence_search`, `confluence_get_page`, `confluence_get_page_children`, `confluence_get_page_ancestors`, `confluence_get_space_page_tree`, `confluence_list_spaces`, `confluence_get_page_history`, `confluence_create_page`, `confluence_update_page`, `confluence_delete_page`, `confluence_move_page_position` |
